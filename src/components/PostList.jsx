...
const PostList = ({ posts, getTermBadgeClass }) => {
  ...
  const hasMetaContent = (post) => {
    if (!post.meta) return false

    return Object.values(post.meta).some((typeData) => {
      if (typeof typeData === 'object') {
        return Object.values(typeData).some((content) =>
